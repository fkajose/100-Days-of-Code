...
If you wish to find the gold and claim that sweet booty, you must find your way wthout the locals' help and battle both nature and their god.
...
if challenge == "yes":
	...
	print("Are you really going to return with your tail between your legs, you fucking coward?\nWell then, have it your way.")

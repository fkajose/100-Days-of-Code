...
|52|[Instagram Follower Bot](/52.%20Instagram%20Follower%20Bot/main.py/)|Developed a Python script that uses Selenium to automate the process of following Instagram accounts of followers of a specified user account.| Selenium web automation framework, Webdriver interface of the Selenium framework, Knowledge of CSS Selectors and XPath for element locating
